...
@archbots.on_message(filters.command(["short"]))
...
@archbots.on_message(filters.command(["unshort"]))
...
# archbots.add_handler(MessageHandler(short_urls))
# archbots.add_handler(MessageHandler(unshort))
__help__ = """
ᴍᴀᴋᴇ sʜᴏʀᴛs ᴏғ ᴀ ɢɪᴠᴇɴ ʟɪɴᴋ 
 ❍ /short <url>  *:Example `/short https://t.me/archbots`.
 *"""
