...
@archbots.on_message(filters.command(["gps"]))
...
#     await message.delete()
    ...
    try:
        ...
        """
        ---------github :-NOOB-archbots -----
        ---------telegram : @itz_legend_coder-----
        """
        geolocator = Nominatim(user_agent="legend-archbots")
#         zoom=[0-18]
...
@archbots.on_message(filters.command(["distance"]))
...
# archbots.add_handler(MessageHandler(gps))     
# archbots.add_handler(MessageHandler(distance))
