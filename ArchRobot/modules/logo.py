...
from ArchRobot.modules.nightmode import button_row
from ArchRobot import BOT_USERNAME, OWNER_ID,BOT_NAME, SUPPORT_CHAT, telethn
...
async def lego(event):
    ...
    try:
        ...
        fnt = glob.glob("./ArchRobot/resources/fonts/*")
