...
# from ArchRobot.modules.sql import warns_sql as warnssql
import ArchRobot.modules.sql.blacklist_sql as blacklistsql

# from ArchRobot.modules.sql import cust_filters_sql as filtersql
# import ArchRobot.modules.sql.welcome_sql as welcsql
import ArchRobot.modules.sql.locks_sql as locksql
import ArchRobot.modules.sql.notes_sql as sql

# from ArchRobot.modules.rules import get_rules
import ArchRobot.modules.sql.rules_sql as rulessql
from ArchRobot import EVENT_LOGS,OWNER_ID, SUPPORT_CHAT, dispatcher
from ArchRobot.__main__ import DATA_IMPORT
from ArchRobot.modules.connection import connected
from ArchRobot.modules.helper_funcs.alternate import typing_action
from ArchRobot.modules.helper_funcs.chat_status import user_admin
from ArchRobot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("ArchRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("ArchRobot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `ArchRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("ArchRobot{}.backup".format(chat_id))  # Cleaning file
