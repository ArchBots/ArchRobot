...
import ArchRobot.modules.no_sql.users_db as sql
...
from ArchRobot.modules.helper_funcs.chat_status import is_user_admin
from ArchRobot.modules.helper_funcs.misc import paginate_modules
...
buttons = [
    [
        InlineKeyboardButton(
            text="♡︎  ᴀᴅᴅ ᴍᴇ ᴍᴏɪ ʟᴜᴠ ♡︎ ",
            url=f"https://t.me/{dispatcher.bot.username}?startgroup=true",
        ),
    ],
    [
        InlineKeyboardButton(text="ʜᴇʟᴩ & ᴄᴏᴍᴍᴀɴᴅs", callback_data="Main_help"),
    ],
    [
        InlineKeyboardButton(text="ᴀʙᴏᴜᴛ", callback_data="archbots_"),
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("ArchRobot.modules." + module_name)
...
def send_help(chat_id, text, keyboard=None):
    ...
    dispatcher.bot.send_photo(
        chat_id=chat_id,photo=START_IMG,
        caption=text,
        ...
        if mod_match:
            ...
            query.message.edit_caption(text,
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data="help_back"),InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", callback_data="archbots_support")]]
                ),
            )
        ...
        query.message.edit_caption(f"*ʜᴇʏ,*🥀\n  *ᴛʜɪs ɪs {dispatcher.bot.first_name}*"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="sᴜᴩᴩᴏʀᴛ", callback_data="archbots_support"
                        ),
                        InlineKeyboardButton(
                    ...
                    [
                        InlineKeyboardButton(
                            text="ᴅᴇᴠᴇʟᴏᴩᴇʀ", url=f"https://t.me/itszoney")
                    ],
                    [
                        InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data="archbots_back"),
                    ],
                ]
            ),
        )
    elif query.data == "archbots_support":
        query.message.edit_caption("**๏ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ᴛᴏ ɢᴇᴛ ʜᴇʟᴩ ᴀɴᴅ ᴍᴏʀᴇ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀ**"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data="archbots_"),
                    ],
                ]
            ),
        )
    elif query.data == "archbots_back":
        first_name = update.effective_user.first_name 
...
def ArchRobot_Main_Callback(update: Update, context: CallbackContext):
    query = update.callback_query
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [InlineKeyboardButton(text="• Hᴏᴍᴇ •", callback_data="archbots_back")]
                ]
            ),
        )
...
*ᴀʟʟ ᴄᴏᴍᴍᴀɴᴅ ᴅᴏɴᴛ ɴᴇᴇᴅ ᴜsᴇ sᴘᴇᴄɪғɪᴄ ᴍᴇssᴀɢᴇ ᴊᴜsᴛ ᴘᴀsᴛᴇ ᴏɴʟʏ ᴄᴏᴍᴍᴀɴᴅ*
 
/htag  - sᴘᴇᴄɪᴀʟ ʜɪɴᴅɪ ᴛᴀɢɢᴇʀ
/ttag    - sᴘᴇᴄɪᴀʟ ᴛᴀᴍɪʟ ᴛᴀɢɢᴇʀ
...
""",parse_mode=ParseMode.MARKDOWN,
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="• ʙᴀᴄᴋ •", callback_data="tagger_help"),InlineKeyboardButton(text="• sᴜᴘᴘᴏʀᴛ •", callback_data="archbots_support")
                    ]
                ]
            ),
            )
    elif query.data=="expert_help":
        query.message.edit_caption("""ᴠᴏɪᴄᴇ ᴛᴀɢɢᴇʀ
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text=" ʙᴀᴄᴋ ", callback_data="Music_"),InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", callback_data="archbots_support")
                    ]
                ]
            ),
        )
...
def get_help(update: Update, context: CallbackContext):
    ...
    if chat.type != chat.PRIVATE:
        ...
        send_help(
            ...
            text,
            InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="◁", callback_data="help_back"),InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", callback_data="archbots_support")]]
            ),
        )
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 6024212623 and DONATION_LINK:
            update.effective_message.reply_text(
                f"» ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴩᴇʀ ᴏғ {dispatcher.bot.first_name} sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ɪs [ɢɪᴛʜᴜʙ](https://github.com/ArchBots/ArchRobot)"
...
""",reply_markup=x,
    ...
    about_callback_handler = CallbackQueryHandler(
        ArchBots_about_callback, pattern=r"archbots_", run_async=True
    )
    ...
    archrobot_main_handler = CallbackQueryHandler(
        ArchRobot_Main_Callback, pattern=r".*_help",run_async=True)
    ...
    dispatcher.add_handler(archrobot_main_handler)
